...
void requestEvent() //接受到master要求的訊息時執行
{
  //當歌曲播放完畢時
...
void set_drum() //設定音符位置及顏色
{
  ...
  for(int i=0 ; i<song_len ; i++)
  {
    ...
    {
      cir_position_star[i] = now; //音符位置設定
