...
unsigned long previousMillis = 0; //儲存上個時間

byte backward[3] = { // 3 2 1 亮的位置
  B01001111, B01011011, B00000110
};

byte pattern[8] = { //設定亮的位置(0不亮，1亮)
  B00100001, B01100000, B01000100, B00001100, B00011000,
  B01010000, B01000010, B00000011
};
...
void loop() 
{
  ...
  for (int i = 0; i < 8; i++) //將8個圖形以迴圈方式進行
  {
    setSegNum(address[7], pattern[i]); //在最右邊顯示pattern亮的地方
    delay(100);
  }
}
